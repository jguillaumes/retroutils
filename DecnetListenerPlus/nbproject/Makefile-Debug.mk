...
${OBJECTDIR}/DecnetListener.o: DecnetListener.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DecnetListener.o DecnetListener.cpp

${OBJECTDIR}/DecnetListenerPcap.o: DecnetListenerPcap.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DecnetListenerPcap.o DecnetListenerPcap.cpp

${OBJECTDIR}/FileSaver.o: FileSaver.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FileSaver.o FileSaver.cpp

${OBJECTDIR}/PcapReader.o: PcapReader.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PcapReader.o PcapReader.cpp
