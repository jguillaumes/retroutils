...
${OBJECTDIR}/BasicHandler.o: BasicHandler.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -s -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BasicHandler.o BasicHandler.cpp

${OBJECTDIR}/CounterHandler.o: CounterHandler.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -s -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CounterHandler.o CounterHandler.cpp

${OBJECTDIR}/DecnetListener.o: DecnetListener.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -s -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DecnetListener.o DecnetListener.cpp

${OBJECTDIR}/DecnetListenerPcap.o: DecnetListenerPcap.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -s -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DecnetListenerPcap.o DecnetListenerPcap.cpp

${OBJECTDIR}/FileSaver.o: FileSaver.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -s -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FileSaver.o FileSaver.cpp

${OBJECTDIR}/PcapReader.o: PcapReader.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -s -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PcapReader.o PcapReader.cpp

${OBJECTDIR}/main.o: main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -s -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp
